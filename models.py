...
def build_lsi(corpus_transform, dictionary, writedir, filename='model.lsi', num_topics=2):
...
def build_lda(corpus_transform, dictionary, writedir, filename='model.lda', num_topics=2):
